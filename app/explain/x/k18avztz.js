...
svg[data-x="k18avztz"] .sm{fill:var(--text);font-size:12.5px;font-weight:700}
...
`,
  ...
  <g data-from="1">
    <text class="sm" x="24" y="140" style="fill:var(--warn)">an affected father has ONE X, and every daughter gets it</text>
  </g>

  <!-- beat 3: so she is a carrier, with certainty -->
  <g data-from="2">
    <path d="M124 67 a16 16 0 0 1 32 0 z" fill="var(--warn)" transform="rotate(-90 140 67)"/>
    <text class="sm" x="140" y="114" text-anchor="middle" style="fill:var(--warn)">X X&#7580;</text>
    <text class="sm" x="24" y="162" style="fill:var(--warn)">obligate carrier &#8212; probability 1, not one half</text>
  </g>
  ...
  <g data-from="3">
    ...
    <text class="sm" x="24" y="210" style="fill:var(--accent)">only which of the mother&#8217;s two X&#8217;s he gets decides it</text>
  </g>
  ...
  <g data-from="4">
    ...
    <text class="sm" x="200" y="284" text-anchor="middle" style="fill:var(--incorrect)">gets X&#7580; &#183; affected</text>
    <text class="lbl" x="140" y="318" text-anchor="middle" style="fill:var(--correct)">50% for any son &#8212; first or fifth</text>
  </g>
  ...
  <g data-from="4">
    ...
    <text class="lbl" x="336" y="230" text-anchor="middle" style="fill:var(--correct)">50%</text>
  </g>
  <g data-from="5">
    <text class="sm" x="388" y="194" style="fill:var(--incorrect)">&#189; for a son &#215; &#189; for the X</text>
    <text class="sm" x="388" y="214" style="fill:var(--incorrect)">but you were GIVEN a son</text>
  </g>
</svg>`,
  steps: [
