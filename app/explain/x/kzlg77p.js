...
`,
  ...
  <text class="lbl" x="150" y="160" fill="var(--incorrect)">Cl</text>
  ...
  <g data-from="1">
    ...
    <text class="sm" x="215" y="150" text-anchor="middle" fill="var(--incorrect)">&minus;Cl⁻</text>
  </g>
  ...
  <g data-from="2">
    ...
    <text class="lbl" x="360" y="76" text-anchor="middle" fill="var(--accent)">+</text>
    <text class="sm" x="360" y="168" text-anchor="middle">planar carbocation</text>
  </g>
  <text class="lbl" x="360" y="196" text-anchor="middle" data-from="3" fill="var(--incorrect)">the stereocenter is gone</text>
  ...
  <g data-from="4">
    ...
    <text class="sm" x="404" y="66" fill="var(--correct)">H₂O from above</text>
    <text class="sm" x="404" y="192" fill="var(--correct)">or below &mdash; equally</text>
  </g>
  ...
  <g data-from="5">
    ...
    <text class="lbl" x="543" y="228" text-anchor="middle" fill="var(--accent)">about 1 : 1</text>
  </g>

  <g data-from="6">
    <rect x="60" y="292" width="520" height="46" rx="16" fill="var(--accent)" opacity=".14"/>
    <text class="lbl" x="320" y="312" text-anchor="middle" fill="var(--accent)">racemic, and optically inactive</text>
    <text class="sm"  x="320" y="330" text-anchor="middle" fill="var(--accent)">inversion would mean SN2, which a tertiary carbon blocks</text>
  </g>
</svg>`,
  steps: [
