...
svg[data-x="k1vnfrkj"] .sm{fill:var(--text);font-size:12.5px;font-weight:700}
...
`,
  ...
  <g data-from="1">
    ...
    <text class="lbl" x="320" y="84" text-anchor="middle" style="fill:var(--accent)">strip the proton, then ask how well the leftover anion spreads its charge</text>
  </g>
  ...
  <g data-from="2">
    ...
    <text class="sm"  x="330" y="168" style="fill:var(--incorrect)">nowhere to spread &#8594; weakest</text>
  </g>
  <g data-from="3">
    ...
    <text class="sm"  x="330" y="222" style="fill:var(--warn)">carbon carries it badly &#8594; middle</text>
  </g>
  <g data-from="4">
    ...
    <text class="sm"  x="330" y="276" style="fill:var(--correct)">and the C=O pulls &#8594; strongest</text>
    <text class="sm"  x="24"  y="300" style="fill:var(--accent)">more resonance forms is not the test &#8212; which ATOM holds the charge is</text>
  </g>
  ...
  <g data-from="5">
    ...
    <text class="lbl" x="204" y="337" text-anchor="middle" style="fill:var(--correct)">ethanol &lt; phenol &lt; acetic acid</text>
