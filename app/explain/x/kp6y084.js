...
`,
  ...
  <text class="lbl" x="99" y="81" text-anchor="middle" style="fill:var(--card)">exon 1</text>
  ...
  <text class="lbl" x="429" y="81" text-anchor="middle" style="fill:var(--card)">exon 2</text>

  <g class="bounds">
    <text class="sm" x="178" y="112" style="fill:var(--correct)">GU</text>
    <text class="sm" x="332" y="112" style="fill:var(--correct)">AG</text>
  ...
  <g class="mut">
    ...
    <text class="sm" x="380" y="112" style="fill:var(--incorrect)">3′ AG destroyed &mdash; boundary invisible</text>
  </g>
  ...
  <g class="kept">
    ...
    <text class="sm" x="264" y="211" text-anchor="middle" style="fill:var(--incorrect)">intron RETAINED</text>
  ...
  <g class="fin">
    ...
    <text class="lbl" x="458" y="340" text-anchor="middle" style="fill:var(--incorrect)">premature stop or frameshift &rarr; broken protein</text>
  </g>
</svg>`,
  steps: [
