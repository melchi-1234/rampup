...
`,
  ...
  <text class="lbl" x="320" y="68" text-anchor="middle" fill="var(--accent)">nostalgia is “a rehearsal in attention”</text>
  ...
  <g data-from="2">
    ...
    <text class="lbl" x="370" y="122" fill="var(--accent)">so it is not about the past</text>
  ...
  <g data-from="4">
    ...
    <text class="lbl" x="320" y="254" text-anchor="middle" fill="var(--correct)">→ comes to value ordinary PRESENT moments</text>
  </g>

  <!-- the two traps -->
  <g data-from="5">
    <text class="sm" x="24" y="292" fill="var(--incorrect)">B · “more reliable than memory” — the phrase says nothing about reliability</text>
  </g>
  <g data-from="6">
    <text class="sm" x="24" y="314" fill="var(--incorrect)">D · “ordinary days are objectively more valuable” — he says we FAIL TO NOTICE their worth,</text>
    <text class="sm" x="24" y="332" fill="var(--incorrect)">which is a claim about us, not a ranking of days</text>
  </g>
</svg>`,
  steps: [
