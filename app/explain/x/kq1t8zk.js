...
svg[data-x="kq1t8zk"] .sm{fill:var(--text);font-size:12.5px;font-weight:700}
...
`,
  ...
  <g data-from="1">
    ...
    <text class="lbl" x="160" y="96" text-anchor="middle" style="fill:var(--incorrect)">3&#176; carbon &#183; shielded</text>
    ...
    <text class="sm" x="300" y="228" style="fill:var(--incorrect)">3&#176; carbon: SN2 has no trajectory</text>
  </g>

  <!-- beat 3: a concentrated base forces the bimolecular path -->
  <g data-from="2">
    <rect x="320" y="74" width="272" height="48" rx="10" fill="var(--surface-2)"/>
    <text class="lbl" x="456" y="96" text-anchor="middle" style="fill:var(--accent)">high [EtO&#8722;] &#183; bimolecular</text>
    ...
    <text class="sm" x="300" y="304" style="fill:var(--incorrect)">that is warm ethanol, base deleted</text>
  </g>
  ...
  <g data-from="3">
    ...
    <text class="lbl" x="320" y="151" text-anchor="middle" style="fill:var(--accent)">E2 it is &#8212; now choose which &#946;-H leaves</text>
  </g>
  ...
  <g data-from="4">
    ...
    <text class="lbl" x="39" y="190" text-anchor="middle" style="fill:var(--correct)">A</text>
    <text class="sm" x="300" y="190" style="fill:var(--correct)">Zaitsev: the trisubstituted alkene</text>
  </g>

  <!-- beat 6: Hofmann needs bulk, and ethoxide has none -->
  <g data-from="5">
    <line x1="64" y1="261" x2="292" y2="261" stroke="var(--incorrect)" stroke-width="1.5"/>
    <text class="sm" x="300" y="266" style="fill:var(--incorrect)">needs a BULKY base, not a strong one</text>
