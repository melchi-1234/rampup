...
`,
  ...
  <g data-from="1" data-to="2">
    ...
    <text class="lbl" x="400" y="140" fill="var(--muted)">a threshold: flat above the line</text>
  </g>
  <text class="lbl" x="340" y="322" text-anchor="middle" data-from="2" data-to="2" fill="var(--incorrect)">that is not what they found</text>
  ...
  <g data-from="3">
    ...
    <text class="lbl" x="180" y="120" data-from="3" fill="var(--accent)">every step up, a little healthier</text>
  </g>
  <g data-from="4">
    ...
    <text class="sm" x="596" y="70" text-anchor="end" fill="var(--correct)">even the top vs the merely comfortable</text>
  </g>
  ...
  <g data-from="6">
    ...
    <text class="lbl" x="340" y="326" text-anchor="middle" fill="var(--accent)">a social gradient across the whole spectrum</text>
    <text class="sm"  x="340" y="344" text-anchor="middle" fill="var(--accent)">and it survived controlling for medical care</text>
  </g>
</svg>`,
  steps: [
