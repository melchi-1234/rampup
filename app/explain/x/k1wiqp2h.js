...
`,
  ...
  <text class="lbl" x="596" y="84" text-anchor="end" style="fill:var(--correct)">simple task</text>
  ...
  <text class="lbl" x="228" y="92" data-from="1" style="fill:var(--accent)">complex task</text>
  ...
  <g data-from="4">
    ...
    <text class="sm" x="248" y="290" text-anchor="middle" style="fill:var(--accent)">best for HARD</text>
    <line x1="560" y1="106" x2="560" y2="272" stroke="var(--correct)" stroke-width="2" stroke-dasharray="4 4"/>
    <text class="sm" x="556" y="290" text-anchor="middle" style="fill:var(--correct)">best for EASY</text>
  </g>

  <g data-from="3">
    <rect x="330" y="176" width="264" height="46" rx="16" fill="var(--accent)" opacity=".16"/>
    <text class="lbl" x="462" y="196" text-anchor="middle" style="fill:var(--accent)">the Yerkes-Dodson law</text>
    <text class="sm"  x="462" y="214" text-anchor="middle" style="fill:var(--accent)">the peak MOVES with difficulty</text>
  </g>
