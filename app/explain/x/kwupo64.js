...
`,
  ...
  <text class="sm" x="274" y="122" data-from="1" style="fill:var(--incorrect)">Vmax falls</text>

  <!-- Km marker: same on both curves -->
  <g data-from="2">
    <line x1="112" y1="200" x2="112" y2="60" stroke="var(--correct)" stroke-width="2" stroke-dasharray="4 4"/>
    <text class="sm" x="112" y="218" text-anchor="middle" style="fill:var(--correct)">Km unchanged</text>
  </g>
  <text class="sm" x="34" y="248" data-from="3" style="fill:var(--correct)">substrate still binds just as well</text>
  ...
  <text class="sm" x="366" y="228" text-anchor="middle" data-from="4" style="fill:var(--correct)">−1/Km</text>
  <text class="sm" x="356" y="250" data-from="5" style="fill:var(--correct)">same Km → same x-intercept</text>
  <text class="sm" x="356" y="268" data-from="5" style="fill:var(--correct)">→ the lines cross ON the x-axis</text>

  <g data-from="6">
    <rect x="24" y="298" width="592" height="46" rx="16" fill="var(--accent)" opacity=".14"/>
    <text class="lbl" x="320" y="318" text-anchor="middle" style="fill:var(--accent)">noncompetitive: it binds a different site altogether</text>
    <text class="sm"  x="320" y="336" text-anchor="middle" style="fill:var(--accent)">with equal affinity for free enzyme and the enzyme-substrate complex</text>
  </g>
</svg>`,
  steps: [
