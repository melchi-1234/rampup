...
`,
  ...
  <!-- what changed -->
  <g data-from="1">
    <text class="lbl" x="70"  y="66" text-anchor="middle" fill="var(--correct)">ATP ↓</text>
    <text class="lbl" x="216" y="66" text-anchor="middle" fill="var(--correct)">citrate ↓</text>
    <text class="lbl" x="400" y="66" text-anchor="middle" fill="var(--warn)">AMP ↑</text>
    <text class="lbl" x="556" y="66" text-anchor="middle" fill="var(--warn)">ADP ↑</text>
  </g>
  ...
  <g data-from="2">
    ...
    <text class="lbl" x="114" y="134" text-anchor="middle" fill="var(--correct)">so ATP falling</text>
    <text class="lbl" x="114" y="152" text-anchor="middle" fill="var(--correct)">lifts a brake</text>
  </g>
  <g data-from="3">
    ...
    <text class="lbl" x="306" y="152" text-anchor="middle" fill="var(--correct)">a second brake lifted</text>
  </g>
  <g data-from="4">
    ...
    <text class="lbl" x="498" y="140" text-anchor="middle" fill="var(--warn)">accelerator down</text>
  </g>
  ...
  <g data-from="5">
    ...
    <text class="lbl" x="320" y="239" text-anchor="middle" fill="var(--accent)">PFK-1 flux surges</text>
  ...
  <g data-from="6">
    ...
    <text class="lbl" x="320" y="336" text-anchor="middle" fill="var(--accent)">past PFK-1 it cannot — which is what &ldquo;committed&rdquo; means</text>
  </g>
</svg>`,
  steps: [
