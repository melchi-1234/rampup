...
`,
  ...
  <g data-from="2">
    ...
    <text class="tag" x="40" y="124" fill="var(--warn)">PART 2 · RAISES A PROBLEM</text>
    <text class="sm"  x="40" y="146" fill="var(--warn)">if every layer is itself contingent, the stripping never reaches bottom</text>
  </g>
  <g data-from="3">
    <rect x="24" y="166" width="592" height="52" rx="14" fill="var(--correct)" opacity=".18"/>
    <text class="tag" x="40" y="186" fill="var(--correct)">PART 3 · OFFERS AN ALTERNATIVE</text>
    <text class="sm"  x="40" y="208" fill="var(--correct)">authenticity = owning your commitments openly instead</text>
  </g>

  <g data-from="4">
    <rect x="130" y="230" width="380" height="34" rx="17" fill="var(--accent)" opacity=".18"/>
    <text class="lbl" x="320" y="253" text-anchor="middle" fill="var(--accent)">shape: view → problem → alternative</text>
    <text class="sm"  x="320" y="280" text-anchor="middle">and notice what it never does: it never declares the first view false</text>
  </g>

  <g data-from="5">
    <text class="sm" x="24" y="306" fill="var(--incorrect)">D · “proves no true self exists” — far stronger than anything he claims</text>
    <text class="sm" x="24" y="324" fill="var(--incorrect)">C · “defends the traditional view” — he questions it, not defends it</text>
  </g>
  <g data-from="6">
    <rect x="330" y="292" width="286" height="44" rx="14"
          fill="var(--correct)" fill-opacity=".2" stroke="var(--correct)" stroke-width="2.5"/>
    <text class="sm"  x="473" y="312" text-anchor="middle" fill="var(--correct)">A · questions one conception,</text>
    <text class="lbl" x="473" y="329" text-anchor="middle" fill="var(--correct)">presents an alternative → A</text>
  </g>
</svg>`,
  steps: [
