...
svg[data-x="kgq3mw4"] .sm{fill:var(--text);font-size:12.5px;font-weight:700}
...
`,
  ...
  <g data-from="1">
    ...
    <text class="lbl" x="320" y="105" text-anchor="middle" style="fill:var(--accent)">f&#8242; = f &#215; v / (v &#8722; vs)</text>
  ...
  <g data-from="2">
    ...
    <text class="lbl" x="320" y="157" text-anchor="middle" style="fill:var(--correct)">500 &#215; 340/306 = 555.6 &#8776; 556 Hz</text>
    <rect x="24" y="210" width="30" height="26" rx="8" fill="var(--correct)" fill-opacity=".2"
          stroke="var(--correct)" stroke-width="2"/>
    <text class="lbl" x="39" y="228" text-anchor="middle" style="fill:var(--correct)">B</text>
    <text class="sm" x="316" y="228" style="fill:var(--correct)">squeezed wavelengths, right formula</text>
  </g>

  <!-- beat 4: 450 is the fraction upside down -->
  <g data-from="3">
    <line x1="64" y1="299" x2="308" y2="299" stroke="var(--incorrect)" stroke-width="1.5"/>
    <text class="sm" x="316" y="304" style="fill:var(--incorrect)">= 500 &#215; 306/340 &#183; the flip</text>
  </g>
  ...
  <g data-from="4">
    ...
    <text class="sm" x="316" y="190" style="fill:var(--incorrect)">source motion shifts pitch too</text>
    <line x1="64" y1="261" x2="308" y2="261" stroke="var(--incorrect)" stroke-width="1.5"/>
    <text class="sm" x="316" y="266" style="fill:var(--incorrect)">that rule gives 500&#215;374/340 = 550</text>
  </g>
