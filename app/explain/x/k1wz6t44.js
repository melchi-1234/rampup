...
`,
  ...
  <g data-from="1">
    ...
    <text class="lbl" x="320" y="71" text-anchor="middle" style="fill:var(--accent)">must enter at or above pyruvate</text>
  </g>
  ...
  <g data-from="2">
    ...
    <text class="sm" x="130" y="172" style="fill:var(--incorrect)">loses CO₂</text>
  </g>
  <g data-from="3">
    <text class="lbl" x="114" y="256" text-anchor="middle" style="fill:var(--incorrect)">irreversible</text>
    <text class="sm"  x="114" y="274" text-anchor="middle" style="fill:var(--incorrect)">no way back to pyruvate</text>
  ...
  <g data-from="5">
    ...
    <text class="sm"  x="320" y="248" text-anchor="middle" style="fill:var(--incorrect)">purely ketogenic</text>
    <text class="sm"  x="320" y="266" text-anchor="middle" style="fill:var(--incorrect)">also only acetyl-CoA</text>
  ...
  <g data-from="6">
    ...
    <text class="lbl" x="526" y="132" text-anchor="middle" style="fill:var(--correct)">glycerol</text>
    ...
    <rect x="436" y="188" width="180" height="40" rx="12"
          fill="var(--correct)" fill-opacity=".18" stroke="var(--correct)" stroke-width="2"/>
    <text class="lbl" x="526" y="214" text-anchor="middle" style="fill:var(--correct)">DHAP → glucose</text>
    <text class="sm"  x="526" y="252" text-anchor="middle" style="fill:var(--correct)">nothing lost on the way</text>
  ...
  <g data-from="4">
    ...
    <text class="lbl" x="320" y="318" text-anchor="middle" style="fill:var(--incorrect)">even-chain fat cannot become NET glucose</text>
    <text class="sm"  x="320" y="336" text-anchor="middle" style="fill:var(--incorrect)">the carbon is already gone as CO₂ before pyruvate</text>
  </g>
</svg>`,
  steps: [
