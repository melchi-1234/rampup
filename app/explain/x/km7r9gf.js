...
svg[data-x="km7r9gf"] .sm{fill:var(--muted);font-size:12.5px;font-weight:600}
...
`,
  ...
  <text class="sm" x="208" y="100" fill="var(--warn)">after: both &#8593;</text>
  ...
  <g data-from="2">
    ...
    <text class="sm" x="112" y="66" text-anchor="end" fill="var(--incorrect)">true d&#8242; &#8593;</text>
    <rect x="320" y="48" width="296" height="62" rx="10" fill="var(--incorrect)" fill-opacity=".10"
          stroke="var(--incorrect)" stroke-width="1.5"/>
    <text class="lbl" x="598" y="74" text-anchor="end" fill="var(--incorrect)">&#10007;</text>
    <line x1="64" y1="220" x2="322" y2="220" stroke="var(--incorrect)" stroke-width="1.5"/>
    <text class="sm" x="330" y="225" fill="var(--incorrect)">but false alarms rose too</text>
  </g>
  ...
  <g data-from="3">
    ...
    <text class="sm" x="236" y="68" fill="var(--correct)">same d&#8242;</text>
    <rect x="320" y="120" width="296" height="62" rx="10" fill="var(--correct)" fill-opacity=".12"
          stroke="var(--correct)" stroke-width="1.5"/>
    <text class="lbl" x="598" y="146" text-anchor="end" fill="var(--correct)">&#10003;</text>
    <rect x="24" y="268" width="30" height="24" rx="8" fill="var(--correct)" fill-opacity=".2"
          stroke="var(--correct)" stroke-width="2"/>
    <text class="lbl" x="39"  y="285" text-anchor="middle" fill="var(--correct)">C</text>
    <text class="sm"  x="64"  y="285" fill="var(--correct)">more lenient criterion, d&#8242; same</text>
    <text class="sm"  x="330" y="285" fill="var(--correct)">&#10003; both moved the same way</text>
  </g>
  ...
  <g data-from="4">
    ...
    <text class="sm" x="330" y="255" fill="var(--incorrect)">receptors, not a decision rule</text>
    <text class="sm" x="330" y="315" fill="var(--incorrect)">threshold &#8593; means fewer, not more</text>
  </g>
