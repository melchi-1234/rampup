...
svg[data-x="k1pdz0rk"] .sm{fill:var(--text);font-size:12.5px;font-weight:700}
...
`,
  ...
  <g data-from="1">
    ...
    <text class="lbl" x="320" y="68" text-anchor="middle" style="fill:var(--accent)">N&#8322; + 3H&#8322; &#8652; 2NH&#8323; + heat &#8212; write it as a product</text>
  </g>
  <g data-from="2">
    <line x1="300" y1="106" x2="180" y2="106" stroke="var(--warn)" stroke-width="2.5"/>
    <polygon points="184,101 172,106 184,111" fill="var(--warn)"/>
    <text class="sm" x="320" y="110" style="fill:var(--warn)">add heat = add a product &#8594; it pushes back LEFT</text>
  </g>
  <g data-from="3">
    <text class="lbl" x="24" y="150" style="fill:var(--incorrect)">less NH&#8323; at the new equilibrium &#183; and K itself falls</text>
  </g>
  ...
  <g data-from="3">
    ...
    <text class="sm" x="352" y="236" style="fill:var(--incorrect)">wrong direction entirely</text>
  </g>
  <g data-from="4">
    <line x1="64" y1="273" x2="380" y2="273" stroke="var(--incorrect)" stroke-width="1.5"/>
    <text class="sm" x="24" y="348" style="fill:var(--incorrect)">temperature is the ONE variable that does change K</text>
  </g>
  <g data-from="5">
    <line x1="64" y1="315" x2="400" y2="315" stroke="var(--incorrect)" stroke-width="1.5"/>
    <text class="sm" x="420" y="320" style="fill:var(--incorrect)">both rates rise</text>
  </g>
</svg>`,
  steps: [
