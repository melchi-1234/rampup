...
svg[data-x="k1l9qll"] .sm{fill:var(--text);font-size:12.5px;font-weight:700}
...
`,
  ...
  <text class="sm" x="529" y="62" text-anchor="middle" style="fill:var(--incorrect)">oligomycin plugs F&#8338;</text>
  ...
  <g data-from="1">
    ...
    <text class="sm" x="290" y="60" text-anchor="middle" style="fill:var(--warn)">H&#8314; H&#8314; H&#8314; &#183; &#916;p high</text>
    <line x1="196" y1="46" x2="196" y2="62" stroke="var(--warn)" stroke-width="2"/>
    <polygon points="196,70 191,60 201,60" fill="var(--warn)"/>
    <text class="lbl" x="152" y="157" style="fill:var(--warn)">low</text>
    <line x1="64" y1="213" x2="380" y2="213" stroke="var(--incorrect)" stroke-width="1.5"/>
    <text class="sm" x="400" y="218" style="fill:var(--incorrect)">the low O&#8322; was back-pressure</text>
  </g>
  ...
  <g data-from="2">
    ...
    <text class="sm" x="362" y="93" text-anchor="middle" style="fill:var(--accent)">DNP</text>
    <line x1="410" y1="58" x2="410" y2="96" stroke="var(--accent)" stroke-width="2"/>
    <polygon points="410,106 405,96 415,96" fill="var(--accent)"/>
    <text class="sm" x="362" y="120" text-anchor="middle" style="fill:var(--accent)">H&#8314; leaks back, &#916;p collapses</text>
  </g>

  <!-- beat 4: brake off, the chain runs flat out -->
  <g data-from="3">
    <text class="lbl" x="190" y="157" style="fill:var(--correct)">&#8594; &#8593;&#8593; heat</text>
    <text class="lbl" x="310" y="250" style="fill:var(--correct)">&#8593;&#8593;</text>
  </g>

  <!-- beat 5: the plug never moved, so ATP stays at zero -->
  <g data-from="4">
    <text class="lbl" x="456" y="157" style="fill:var(--correct)">&#8594; still 0</text>
    ...
    <text class="lbl" x="39"  y="250" text-anchor="middle" style="fill:var(--correct)">B</text>
    <text class="lbl" x="356" y="250" style="fill:var(--correct)">0</text>
    <text class="sm"  x="400" y="250" style="fill:var(--correct)">&#10003; matches both readouts</text>
    ...
    <text class="sm" x="400" y="282" style="fill:var(--incorrect)">no protonophore makes ATP</text>
    <text class="sm" x="400" y="314" style="fill:var(--incorrect)">uncoupler = the opposite word</text>
  </g>
