...
`,
  ...
  <g data-from="1">
    ...
    <text class="lbl" x="320" y="94" text-anchor="middle" style="fill:var(--accent)">not the decay — the GAP the decay leaves</text>
  </g>
  ...
  <g data-from="3">
    ...
    <text class="lbl" x="320" y="190" text-anchor="middle" style="fill:var(--accent)">the viewer gets to PARTICIPATE</text>
  </g>

  <!-- what restoration does to it -->
  <g data-from="4">
    <rect x="24" y="204" width="592" height="46" rx="14" fill="var(--incorrect)" opacity=".16"/>
    <text class="sm"  x="320" y="226" text-anchor="middle" style="fill:var(--incorrect)">restoration fills the gap in, and he says it</text>
    <text class="lbl" x="320" y="244" text-anchor="middle" style="fill:var(--incorrect)">“dismisses the beholder from the work”</text>
  </g>

  <g data-from="5">
    <rect x="130" y="262" width="380" height="34" rx="17" fill="var(--correct)" opacity=".2"/>
    <text class="lbl" x="320" y="285" text-anchor="middle" style="fill:var(--correct)">the loss is the participation → C</text>
  </g>

  <!-- the trap -->
  <g data-from="6">
    <rect class="box" x="24" y="306" width="592" height="46" rx="14"/>
    <text class="sm" x="40" y="326" style="fill:var(--warn)">A is the trap: “substitutes the makers' intention for time's revisions” is TRUE…</text>
    <text class="sm" x="40" y="344" style="fill:var(--warn)">…but it describes what restoration DOES, not why he calls it a loss</text>
  </g>
</svg>`,
  steps: [
