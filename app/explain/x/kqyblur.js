...
`,
  ...
  <g data-from="3">
    ...
    <text class="sm"  x="117" y="222" text-anchor="middle" fill="var(--muted)">a function, not a worry</text>
  </g>
  <g data-from="4">
    ...
    <text class="sm"  x="320" y="222" text-anchor="middle" fill="var(--muted)">meaning, not power</text>
  </g>
  <g data-from="6">
    <rect x="430" y="130" width="186" height="104" rx="14"
          fill="var(--correct)" fill-opacity=".18" stroke="var(--correct)" stroke-width="2"/>
    <text class="lbl" x="523" y="156" text-anchor="middle" fill="var(--correct)">conflict theory</text>
    ...
    <text class="lbl" x="523" y="222" text-anchor="middle" fill="var(--correct)">✓</text>
  </g>

  <!-- the stated concern is the discriminator -->
  <g data-from="5">
    <rect x="120" y="256" width="400" height="42" rx="16" fill="var(--warn)" opacity=".18"/>
    <text class="lbl" x="320" y="282" text-anchor="middle" fill="var(--warn)">the stated concern: expanding authority and social control</text>
  </g>
  <g data-from="6">
    <text class="sm" x="320" y="330" text-anchor="middle" fill="var(--accent)">match the lens to the CONCERN, not to the topic</text>
  </g>
</svg>`,
  steps: [
