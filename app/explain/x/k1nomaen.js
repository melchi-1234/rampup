...
`,
  ...
  <g data-from="2">
    ...
    <text class="tag" x="346" y="60" fill="var(--incorrect)">ABUSE</text>
    <text class="sm"  x="346" y="80" fill="var(--incorrect)">borrowed gravity for something unearned</text>
  </g>

  <!-- the two conditions -->
  <g data-from="3">
    <rect x="24" y="104" width="592" height="38" rx="14" fill="var(--accent)" opacity=".16"/>
    <text class="lbl" x="320" y="128" text-anchor="middle" fill="var(--accent)">so it needs BOTH: an undeserving work · and the setting doing the work</text>
  </g>
  ...
  <g data-from="4">
    ...
    <text class="sm" x="600" y="178" text-anchor="end" fill="var(--incorrect)">shows the POWER, not abuse</text>
  </g>
  <g data-from="5">
    ...
    <text class="sm" x="600" y="218" text-anchor="end" fill="var(--incorrect)">his own example of the power</text>
  </g>
  <g data-from="5">
    <rect class="box" x="24" y="236" width="592" height="34" rx="12"/>
    <text class="sm" x="40" y="258">D · a viewer studies a masterwork closely</text>
    <text class="sm" x="600" y="258" text-anchor="end" fill="var(--incorrect)">deserving work → not abuse</text>
  </g>
  <g data-from="6">
    <rect x="24" y="276" width="592" height="42" rx="12"
          fill="var(--correct)" fill-opacity=".2" stroke="var(--correct)" stroke-width="2.5"/>
    <text class="sm"  x="40" y="296" fill="var(--correct)">C · a shallow work draws reverent crowds because of an imposing setting</text>
    <text class="lbl" x="40" y="313" fill="var(--correct)">undeserving ✓ · the setting is doing it ✓</text>
  </g>
