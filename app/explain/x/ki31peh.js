...
`,
  ...
  <text class="sm" x="200" y="164" text-anchor="middle" fill="var(--correct)">regulatory</text>
  <text class="sm" x="150" y="196" text-anchor="middle" data-from="0">two separate sites</text>

  <g data-from="1">
    <circle cx="200" cy="126" r="9" fill="var(--warn)"/>
    <text class="sm" x="272" y="112" fill="var(--warn)">high ATP binds here</text>
    <text class="sm" x="272" y="130" fill="var(--warn)">→ enzyme slows down</text>
  ...
  <g data-from="2">
    ...
    <text class="sm" x="200" y="334" text-anchor="middle" fill="var(--incorrect)">regulatory: dead</text>
  </g>

  <!-- consequences -->
  <g data-from="3">
    <rect class="box" x="300" y="196" width="316" height="56" rx="14"/>
    <text class="lbl" x="458" y="220" text-anchor="middle" fill="var(--correct)">Vmax unchanged · Km unchanged</text>
    <text class="sm"  x="458" y="240" text-anchor="middle">the chemistry still works perfectly</text>
  </g>
  <text class="lbl" x="458" y="278" text-anchor="middle" data-from="4" fill="var(--incorrect)">it just cannot hear the stop signal</text>

  <g data-from="5">
    <rect x="300" y="292" width="316" height="52" rx="14" fill="var(--incorrect)" opacity=".16"/>
    <text class="lbl" x="458" y="314" text-anchor="middle" fill="var(--incorrect)">ATP rises → glycolysis does not slow</text>
    <text class="sm"  x="458" y="332" text-anchor="middle" fill="var(--incorrect)">flux keeps running when it should stop</text>
  </g>
  <text class="lbl" x="458" y="70" text-anchor="middle" data-from="6" fill="var(--accent)">a broken brake, not a broken engine</text>
