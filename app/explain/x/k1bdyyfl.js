...
`,
  ...
  <text class="lbl" x="40" y="104" data-from="1" fill="var(--correct)">→ hallucinations fall</text>
  ...
  <text class="lbl" x="362" y="104" data-from="3" fill="var(--incorrect)">→ can cause them</text>
  ...
  <text class="sm" x="150" y="180" data-from="4" fill="var(--accent)">turn it down &rarr; less</text>
  <text class="sm" x="490" y="180" data-from="4" text-anchor="end" fill="var(--accent)">turn it up &rarr; more</text>

  <g data-from="5">
    <rect x="182" y="206" width="276" height="46" rx="16" fill="var(--accent)" opacity=".18"/>
    <text class="lbl" x="320" y="234" text-anchor="middle" fill="var(--accent)">two independent arrows, same direction</text>
  </g>

  <g data-from="6">
    <rect x="140" y="268" width="360" height="34" rx="17" fill="var(--correct)" opacity=".18"/>
    <text class="lbl" x="320" y="291" text-anchor="middle" fill="var(--correct)">excess dopamine drives the positive symptoms</text>
