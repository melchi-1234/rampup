...
`,
  ...
  <g data-from="0">
    ...
    <text class="sm" x="473" y="110" text-anchor="middle" style="fill:var(--incorrect)">rotenone blocks complex I</text>
  </g>
  ...
  <g data-from="1">
    ...
    <text class="lbl" x="473" y="176" text-anchor="middle" style="fill:var(--warn)">NADH → NAD⁺</text>
    <text class="sm"  x="473" y="194" text-anchor="middle" style="fill:var(--incorrect)">not any more</text>
  </g>
  <g data-from="2">
    <text class="lbl" x="473" y="226" text-anchor="middle" style="fill:var(--incorrect)">NADH piles up · NAD⁺ runs out</text>
  </g>
  ...
  <g data-from="3">
    ...
    <text class="lbl" x="159" y="136" text-anchor="middle" style="fill:var(--accent)">GAPDH step</text>
    <text class="sm"  x="159" y="158" text-anchor="middle" style="fill:var(--accent)">CONSUMES NAD⁺</text>
    <text class="sm"  x="159" y="172" text-anchor="middle">every single turn</text>
  </g>
  <g data-from="4">
    <text class="sm" x="159" y="216" text-anchor="middle" style="fill:var(--incorrect)">no NAD⁺ → glycolysis stalls</text>
    <text class="sm" x="159" y="234" text-anchor="middle" style="fill:var(--incorrect)">and it is now the ONLY ATP source</text>
  </g>
  ...
  <g data-from="5">
    ...
    <text class="lbl" x="320" y="280" text-anchor="middle" style="fill:var(--correct)">pyruvate + NADH → lactate + NAD⁺</text>
    <text class="sm"  x="320" y="299" text-anchor="middle" style="fill:var(--correct)">the cell buys its NAD⁺ back, and glycolysis keeps running</text>
  </g>
  <text class="lbl" x="320" y="336" text-anchor="middle" data-from="6" style="fill:var(--accent)">lactate is where the electrons get dumped — NAD⁺ is the point</text>
</svg>`,
  steps: [
