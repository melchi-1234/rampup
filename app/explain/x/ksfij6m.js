...
svg[data-x="ksfij6m"] .sm{fill:var(--muted);font-size:12.5px;font-weight:600}
...
`,
  ...
  <g data-from="1">
    <text class="lbl" x="24" y="56" fill="var(--accent)">two questions settle all four choices</text>
  ...
  <g data-from="2">
    ...
    <text class="sm" x="378" y="286" text-anchor="middle" fill="var(--incorrect)">her buckling went UP, so the whole bottom row is out</text>
  </g>
  <g data-from="3">
    <line x1="196" y1="154" x2="360" y2="154" stroke="var(--incorrect)" stroke-width="1.5"/>
    <text class="sm" x="24" y="310" fill="var(--warn)">and nothing was added &#8212; the buzzer STOPPED</text>
  </g>
  <g data-from="4">
    <rect x="390" y="128" width="176" height="52" rx="10" fill="var(--correct)" fill-opacity=".2"
          stroke="var(--correct)" stroke-width="2.5"/>
    <text class="sm" x="478" y="158" text-anchor="middle" fill="var(--correct)">negative reinforcement</text>
  </g>
  <g data-from="5">
    <text class="lbl" x="24" y="342" fill="var(--accent)">&#8220;negative&#8221; means SUBTRACTED, not unpleasant</text>
  </g>
</svg>`,
  steps: [
