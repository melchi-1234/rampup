...
svg[data-x="kdqlre0"] .sm{fill:var(--muted);font-size:12.5px;font-weight:600}
...
`,
  ...
  <g data-from="1">
    <text class="lbl" x="24" y="56" fill="var(--accent)">strong base + 3&#176; carbon &#8594; E2 elimination</text>
  ...
  <g data-from="2">
    ...
    <text class="lbl" x="320" y="114" text-anchor="middle" fill="var(--warn)">the usual rule is Zaitsev: take the MORE substituted alkene</text>
  </g>
  <g data-from="3">
    ...
    <text class="sm" x="470" y="162" text-anchor="middle" fill="var(--incorrect)">too bulky</text>
  </g>
  <g data-from="4">
    <text class="sm" x="24" y="212" fill="var(--accent)">so it reaches past them to an exposed hydrogen on the outer methyl</text>
  </g>
  ...
  <g data-from="5">
    ...
    <text class="sm" x="64"  y="274" fill="var(--correct)">less substituted &#8212; the Hofmann product</text>
    <text class="sm" x="64"  y="316" fill="var(--incorrect)">Zaitsev &#8212; right rule, wrong base</text>
    <text class="sm" x="370" y="274" fill="var(--incorrect)">wrong carbon skeleton</text>
    <text class="sm" x="370" y="316" fill="var(--incorrect)">substitution, not elimination</text>
  </g>
</svg>`,
  steps: [
