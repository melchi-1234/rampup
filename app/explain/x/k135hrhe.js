...
svg[data-x="k135hrhe"] .sm{fill:var(--muted);font-size:12.5px;font-weight:600}
...
`,
  ...
  <g data-from="1">
    <text class="sm" x="24" y="50" fill="var(--accent)">all four theories use the same three events &#8212; they disagree only on the ORDER</text>
  </g>
  ...
  <g data-from="2">
    ...
    <text class="sm" x="267" y="88" text-anchor="middle" fill="var(--warn)">racing heart, shaking</text>
    <text class="sm" x="435" y="88" text-anchor="middle" fill="var(--correct)">&#8220;then I felt afraid&#8221;</text>
  ...
  <g data-from="3">
    ...
    <text class="sm" x="480" y="186" fill="var(--correct)">exactly her order</text>
  </g>
  ...
  <g data-from="4">
    ...
    <text class="sm" x="490" y="222" fill="var(--incorrect)">then nothing is first</text>
    <text class="sm" x="490" y="258" fill="var(--incorrect)">she appraised after</text>
  </g>

  <!-- beat 6: the trap -->
  <g data-from="5">
    <line x1="250" y1="289" x2="530" y2="289" stroke="var(--incorrect)" stroke-width="1.5"/>
    <text class="sm" x="24" y="330" fill="var(--incorrect)">two-factor needs the label to come from the SITUATION &#8212; she read it off her own body</text>
  </g>
</svg>`,
  steps: [
