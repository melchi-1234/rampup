...
svg[data-x="kj4tz8m"] .sm{fill:var(--muted);font-size:12.5px;font-weight:600}
...
`,
  ...
  <g data-from="1">
    ...
    <text class="lbl" x="320" y="66" text-anchor="middle" fill="var(--accent)">a reducing agent breaks exactly one bond: S&#8722;S</text>
  ...
  <g data-from="2">
    ...
    <text class="sm"  x="280" y="102" text-anchor="middle" fill="var(--incorrect)">DTT cuts</text>
    <text class="sm"  x="352" y="128" fill="var(--correct)">3 bridges cut &#8594; tertiary fold unravels</text>
    ...
    <text class="lbl" x="39" y="257" text-anchor="middle" fill="var(--correct)">C</text>
    <text class="sm"  x="66" y="257" fill="var(--correct)">covalent Cys&#8211;Cys disulfides &#8212; tertiary structure</text>
    <text class="sm"  x="66" y="275" fill="var(--correct)">the one bond a reductant can break</text>
  </g>
  ...
  <g data-from="3">
    ...
    <text class="sm" x="66" y="191" fill="var(--incorrect)">salt bridges are tertiary, and DTT ignores charge</text>
  </g>
  ...
  <g data-from="4">
    ...
    <text class="sm" x="66" y="233" fill="var(--incorrect)">helix H-bonds run backbone C=O to N&#8211;H, and are 2&#176;</text>
    <text class="sm" x="66" y="317" fill="var(--incorrect)">that is a protease &#8212; the opposite of reduction</text>
  </g>
